...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        bn: "LFM এআই এর সাথে বুদ্ধিমত্তার সাথে কথা বলুন",
                        en: "Have an intelligent conversation with LFM AI",
                        vi: "Nói chuyện thông minh với LFM AI"
                },
                category: "ai",
                guide: {
        ...
        onStart: async function ({ api, event, args, message, getLang, commandName }) {
                ...
                return module.exports.handleLFM({ api, event, prompt, getLang, commandName });
        },
        ...
        handleLFM: async function ({ api, event, prompt, getLang, commandName }) {
                try {
