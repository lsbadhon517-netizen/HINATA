...
module.exports = {
        ...
        langs: {
                bn: {
                        noTarget: "• বেবি, কাকে monkey বানাবে? মেনশন, রিপ্লাই বা UID দাও",
                        error: "❌ An error occurred: contact MahMUD %1\n•WhatsApp: 01836298139",
                        success: "Effect monkey successful"
                },
                en: {
                ...
                vi: {
                        ...
                        error: "❌ An error occurred: contact MahMUD %1\n•WhatsApp: 01836298139",
                        success: "Hiệu ứng monkey thành công"
                }
        },
        ...
        onStart: async function ({ api, event, args, getLang }) {
                ...
                try {
                        ...
                        const url = `${apiUrl}/api/dig?type=monkey&user=${id2}`;
