...
module.exports = {
  ...
  onStart: async function ({ api, event, args, message }) {
    ...
    const videoPath = path.join(cacheDir, `aniedit_${Date.now()}.mp4`);
    ...
    try {
      ...
      console.error("aniedit cmd error:", err);
      api.setMessageReaction("❌", event.messageID, () => {}, true);
